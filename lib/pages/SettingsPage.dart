...
class _SettingsPageState extends State<SettingsPage> {
  ...
  String developerName = "Guntur Bagus Aryoga";
  String developerNim = "2141764131";
  String dateApp = "23 September 2023";
          ...
          children: [
            ...
            Row(
              children: [
                const CircleAvatar(
                  backgroundImage:
                      AssetImage('assets/images/biru.png'), // path foto profil
                  radius: 50,
                ),
                Container(
